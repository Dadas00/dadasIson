                  ...
                  Row(       
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          SizedBox(height: 30,),
                          Text('SMARTAPAGA LLC', style: TextStyle(color: Colors.green, fontSize: 22),),
                          Text('Waste Managment Solutions', style: TextStyle(color: Colors.green[700], fontSize: 16),)
                        ]
                      ),
                    ],
                  ),
...
more sustainable Armenia! 
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      errorText: isValedText ? null : 'Invalid Phone Number or Email',
                    ),
  ...
  void _onTextFieldChange() {
    ...
    setState(() {
      isValedText = Validators.isValidEmail(text) || Validators.isValidPhone(text); 
    });
  }
        ...
        if (status == 1) {
          _sendCode(parametr, (s) {
            if (s == 1) {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => VerifyCodeScreen(screen: 'ForgotPassword')),
              );
            }
          });
        }
