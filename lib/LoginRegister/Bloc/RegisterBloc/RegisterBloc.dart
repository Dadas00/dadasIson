...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  Stream<RegisterState> _mapRegisterLegalNameChangeToState(String legalName) async* {
    yield state.update(isLegalNameValid: Validators.isValidLegalName(legalName));
  }

  Stream<RegisterState> _mapRegisterTaxCodeChangeToState(String taxCode) async* {
    yield state.update(isTaxCodeValid: Validators.isValidTaxCode(taxCode));
  }

  Stream<RegisterState> _mapRegisterLegalAddressChangeToState(String legalAddress) async* {
    yield state.update(isLegalAddressValid: Validators.isValidLegalAddress(legalAddress));
  }
  ...
  Stream<RegisterState> _mapRegisterCompanyEmailChangeToState(String companyEmail) async* {
    yield state.update(isCompanyEmailValid: Validators.isValidEmail(companyEmail));
  }
